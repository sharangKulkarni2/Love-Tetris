...
var images = ['rsz_b.jpg', 'rsz_c.jpg', 'rsz_d.jpg', 'rsz_e.jpg', 'rsz_f.jpg', 'rsz_x.jpg', 'rsz_y.jpg']
var azusa = document.getElementById('azusa-image')
var azusa_counter = 0
...
function addScore() {
    for (let i = 0; i < 199; i += width) {
        ...
        if (row.every(index => squares[index].classList.contains('taken'))) {
            ...
            if (azusa_counter === 7)
                azusa_counter = 0
            azusa.src = images[azusa_counter]
            azusa_counter++
